...
class _InventoryScreenState extends ConsumerState<InventoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Filtra: mostra castle solo se l'utente ha dichiarato di possederlo
    final visibleTiles = kTileTypes
        .where((t) => !t.isCastleSpecial || settings.hasCastleSet)
        .toList();
    ...
    return Scaffold(
      ...
      body: visibleTiles.isEmpty
          ? Center(
              child: Text('Nessuna piastrella disponibile',
                  ...
                  child: Row(
                    children: [
                      SizedBox(
                        ...
                        child: CustomPaint(
                            painter: TilePainter(
                                shape: tile.shape, color: tile.color)),
                      ),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(icon,
            size: 18,
            color: enabled ? Colors.white : const Color(0xFFB2BEC3)),
      ),
    );
  }
}
